...
const PRODUCTS = [
  {
    ...
    category: "home",
    featured: true,
    images: ["public/images/products/car-diffusers/dif1.jpg"],
  ...
  },
  {
    ...
    category: "home",
    featured: true,
    images: ["public/images/products/car-diffusers/dif2.jpg"],
...
const App = () => {
  ...
  const completeOrder = () => {
    ...
    window.open(`https://wa.me/27677782468?text=${encodedMessage}`, '_blank');
  };
            ...
            <nav className="hidden md:flex space-x-10">
              {[
                ...
                >
                  {item.label}
                  <motion.span 
                    className="absolute bottom-0 left-0 w-0 h-px bg-amber-700 group-hover:w-full transition-all duration-300"
                ...
                <nav className="flex flex-col space-y-4">
                  {[
                    ...
                    <motion.button
                      ...
                      className="text-stone-700 hover:text-amber-700 tracking-wide text-sm text-left"
                    >
                      {item.label}
                    </motion.button>
                  ))}
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <ScrollAnimatedSection className="text-center mb-20">
            ...
            <h2 className="text-5xl font-serif text-stone-900 tracking-tight justify-center">November Collection</h2>
